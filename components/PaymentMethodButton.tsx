...
export default function PaymentMethodButton({
  ...
  return (
    <button
      ...
      className="group flex flex-col items-center gap-2.5 rounded-xl border-2 border-black/10 bg-white py-5 transition-all duration-200 ease-out hover:-translate-y-1 hover:scale-[1.03] hover:border-[var(--provider-color)] hover:bg-[var(--provider-color)]/5 hover:shadow-lg disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:scale-100"
    >
      <div
        className="flex h-11 w-11 items-center justify-center rounded-xl overflow-hidden shadow-sm ring-1 ring-black/5 transition-transform duration-200 ease-out group-hover:scale-110"
