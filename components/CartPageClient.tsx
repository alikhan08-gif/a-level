...
export default function CartPageClient({ locale }: { locale: Locale }) {
  ...
  const { items, incrementItem, decrementItem, removeItem, totalPrice, totalCount, clear } = useCart();
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <DeliveryMethodButton
                method="UZPOST"
                subtitle={formatTemplate(dict.bookOrder.deliveryFeeUpfront, {
                  amount: formatPrice(getDeliveryFee("UZPOST", totalCount)),
                })}
        ...
        {step === "payment" && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-brand-navy/60">
              {dict.cart.total}: {formatPrice(totalPrice + (deliveryMethod ? getDeliveryFee(deliveryMethod, totalCount) : 0))}{" "}
