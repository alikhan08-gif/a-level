// Shared source of truth for the public offer agreement — used by the
// /shartnoma page, the in-page contract modal, and the PDF export, so all
// three always show exactly the same text.
export type OfferSection = { title: string; body: string[] };

export const OFFER_TITLE_UZ = "Ommaviy oferta shartnomasi";
export const OFFER_TITLE_EN = "Public Offer Agreement";

export const OFFER_SECTIONS_UZ: OfferSection[] = [
  {
    ...
    body: [
      ...
      `1.2. Platformaga ro'yxatdan o'tish, kursga yozilish yoki to'lovni amalga oshirish orqali foydalanuvchi (keyingi o'rinlarda — "O'quvchi") ushbu Shartnoma shartlarini to'liq va so'zsiz qabul qilgan hisoblanadi (O'zbekiston Respublikasi Fuqarolik kodeksining 369-moddasiga muvofiq ommaviy oferta).`,
    ],
  },
  {
...
export const OFFER_SECTIONS_EN: OfferSection[] = [
  {
